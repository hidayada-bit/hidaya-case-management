            ...
            {!isPdf && (
              <>
                <button onClick={() => setZoom(z => Math.max(0.5, z - 0.25))}
                  style={{ background: '#1e3a1e', color: B.gold, border: `1px solid rgba(245,168,0,0.3)`, borderRadius: 8, width: 32, height: 32, fontSize: 18, cursor: 'pointer', fontWeight: 700 }}>−</button>
                <span style={{ color: '#fff', fontSize: 12, fontWeight: 700, minWidth: 40, textAlign: 'center' }}>{Math.round(zoom * 100)}%</span>
                <button onClick={() => setZoom(z => Math.min(4, z + 0.25))}
                  style={{ background: '#1e3a1e', color: B.gold, border: `1px solid rgba(245,168,0,0.3)`, borderRadius: 8, width: 32, height: 32, fontSize: 18, cursor: 'pointer', fontWeight: 700 }}>+</button>
                <button onClick={() => setZoom(1)}
                  style={{ background: '#1e3a1e', color: '#81c784', border: `1px solid rgba(245,168,0,0.3)`, borderRadius: 8, padding: '0 10px', height: 32, fontSize: 11, cursor: 'pointer', fontWeight: 700 }}>Reset</button>
              </>
            )}
            <a href={doc.file_url} download target="_blank" rel="noreferrer"
              style={{ background: B.green, color: '#fff', border: 'none', borderRadius: 8, padding: '6px 14px', fontSize: 12, fontWeight: 700, cursor: 'pointer', textDecoration: 'none' }}>⬇ Download</a>
